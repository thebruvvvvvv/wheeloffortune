SMODS.Consumable {
    ...
    loc_txt = {
        name = 'Duratanium',
        text = {
            [1] = 'Select up to 3 cards to have {C:chips}+8 Chips{} and',
            [2] = '{C:red}+1 Mult{} added to them'
        }
    },
    cost = 3,
    unlocked = true,
            ...
            for i = 1, #G.hand.highlighted do
                G.E_MANAGER:add_event(Event({
                    ...
                    func = function()
                        ...
                        G.hand.highlighted[i].ability.perma_bonus = G.hand.highlighted[i].ability.perma_bonus + 8
                        return true
                    end
                }))
            end
