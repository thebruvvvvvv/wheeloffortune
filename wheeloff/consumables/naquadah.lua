SMODS.Consumable {
    ...
    loc_txt = {
        name = 'Naquadah',
        text = {
            [1] = 'Select up to three cards to have {X:blue,C:white}X0.1{} {C:chips}Chips {}added to them.'
        }
    },
    cost = 5,
    unlocked = true,
            ...
            for i = 1, #G.hand.highlighted do
                G.E_MANAGER:add_event(Event({
                    ...
                    func = function()
                        ...
                        G.hand.highlighted[i].ability.perma_x_chips = G.hand.highlighted[i].ability.perma_x_chips + 0.1
                        return true
                    end
                }))
            end
