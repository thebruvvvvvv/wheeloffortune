...
SMODS.Consumable {
    ...
    loc_txt = {
        name = 'Troxinium',
        text = {
            [1] = 'Select up to 3 cards to give {C:money}$2{}',
            [2] = 'when scored and when held in hand'
        }
    },
    cost = 8,
    unlocked = true,
            ...
            for i = 1, #G.hand.highlighted do
                G.E_MANAGER:add_event(Event({
                    ...
                    func = function()
                        ...
                        G.hand.highlighted[i].ability.perma_p_dollars = G.hand.highlighted[i].ability.perma_p_dollars + 2
                        return true
                    end
                }))
            end
            ...
            for i = 1, #G.hand.highlighted do
                G.E_MANAGER:add_event(Event({
                    ...
                    func = function()
                        ...
                        G.hand.highlighted[i].ability.perma_h_dollars = G.hand.highlighted[i].ability.perma_h_dollars + 2
                        return true
                    end
                }))
            end
