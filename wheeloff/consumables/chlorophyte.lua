SMODS.Consumable {
    ...
    loc_txt = {
        name = 'Chlorophyte',
        text = {
            [1] = 'Select up to 3 cards to give {X:blue,C:white}X0.05{} {C:blue}Chips {}',
        ...
        for i = 1, #G.hand.highlighted do
            G.E_MANAGER:add_event(Event({
                ...
                func = function()
                    ...
                    G.hand.highlighted[i].ability.perma_x_chips = G.hand.highlighted[i].ability.perma_x_chips + 0.05
                    return true
                end
            }))
        end
            ...
            for i = 1, #G.hand.highlighted do
                G.E_MANAGER:add_event(Event({
                    ...
                    func = function()
                        ...
                        G.hand.highlighted[i].ability.perma_p_dollars = G.hand.highlighted[i].ability.perma_p_dollars + 1
                        return true
                    end
                }))
            end
