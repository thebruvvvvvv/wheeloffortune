SMODS.Consumable {
    ...
    loc_txt = {
        name = 'Mythril',
        text = {
            [1] = 'Select up to 3 cards to have',
            [2] = '{C:red}1 Mult{} and {C:money}$2 {}added to them.'
        }
    },
    cost = 5,
    unlocked = true,
                ...
                G.E_MANAGER:add_event(Event({
                   ...
                   delay = 0.1,
                    func = function()
                        ...
                        G.hand.highlighted[i].ability.perma_mult = G.hand.highlighted[i].ability.perma_mult + 1
                        return true
                    end
                }))
            end    
